...
(function (ns) {
  ...
  ns.Player = function (authorizeUrl, contentServerUrl) {
    ...
    eventListener = function (topic, data) {
      ...
      silenceWorkaround = function() {
          var audio = new Audio();
          if(contentServerUrl) {
              audio.src = contentServerUrl + "/audio_cues/silence.mp3";
              audio.setAttribute("id", "silence");
              document.body.append(audio);
              document.getElementById("playButton").addEventListener("click", function (e) {
                  var silenceAudio = document.getElementById('silence');
                  var promise = silenceAudio.play();
                  if (promise !== undefined) {
