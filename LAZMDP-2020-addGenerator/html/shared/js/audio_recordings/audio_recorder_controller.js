...
(function (ns) {
    ...
    ns.RecordingController = function () {
        ...
        var initialize = function (recordingInfo) {
            ...
            audioRecording.initialize(recordingData.state, parseInt(recordingData.total_ms_recorded), maxSeconds,
                recordingData.max_inactivity_seconds);
            ...
            window.swfMicrophone =
                new ns.SwfMicrophone("swfMicrophone", "/flash/microphone.swf", "swfMicrophone", "embeddedMicrophone");
