//  Voy.Tooltip is heavily based on the work of 
...
Voy.Tooltips = Class.create();
Object.extend( Voy.Tooltips, {
  tips: [],
  zIndex: 1200,
...
Voy.Tooltip = Class.create();
Object.extend( Voy.Tooltip.prototype, {
  initialize: function(element, content) {
    this.element = $(element);
    Voy.Tooltips.remove(this.element);
    ...
    this.options = Object.extend({
      ...
      offset: (arguments[2] && arguments[2].hook) ? {x:0, y:0} : {x:8, y:8}, // if hook is declared, set it to 0,0; otherwise 8,8
